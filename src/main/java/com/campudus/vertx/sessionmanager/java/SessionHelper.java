...
public class SessionHelper {
	 ...
	 */
	public SessionHelper(Vertx vertx, String sessionManagerAddress, String cookieField) {
	 ...
	 *            A handler for the received data.
	 */
	public void withSessionData(String sessionId, String requiredField,
			final Handler<JsonObject> handler) {
	 ...
	 */
	public void putSessionData(HttpServerRequest req, JsonObject obj,
			Handler<JsonObject> doneHandler) {
	...
	private void sendPutData(final HttpServerRequest req, final JsonObject obj,
	...
	private void sendPutData(String sessionId, JsonObject putObject,
			final Handler<JsonObject> doneHandler) {
